...
const mockProjects = [
    {
        ...
        description: "Modernizing the ERM frontend with React 19 and Tailwind CSS v4.",
        status: "Active",
        progress: 65,
        members: [
...
const mockSprints = {
    1: [
        { id: 101, name: "Sprint 1: Foundation", status: "Completed", startDate: "2026-01-10", endDate: "2026-01-24", progress: 100 },
        { id: 102, name: "Sprint 2: UI Components", status: "Active", startDate: "2026-01-25", endDate: "2026-02-08", progress: 80 },
        { id: 103, name: "Sprint 3: Integration", status: "Backlog", startDate: "2026-02-09", endDate: "2026-02-23", progress: 0 },
    ],
    2: [
        { id: 201, name: "Sprint 1: AI Prompts", status: "Active", startDate: "2026-02-15", endDate: "2026-03-01", progress: 40 },
    ],
}
    ...
    102: [
        {
            ...
            description: "Create a responsive theme switcher component supporting light/dark modes.",
            status: "Done",
            assignee: { id: 1, name: "Alice Smith", avatar: "https://i.pravatar.cc/150?u=1" },
            priority: "High",
            estimatedHours: 4,
            actualHours: 5,
            ...
            comments: [
                { id: 1, author: "Alice Smith", text: "Initial design completed", createdAt: "2026-01-25" },
            ],
        },
        {
            id: "TASK-002",
            ...
            description: "Create responsive grid system that adapts to 375px, 768px, and 1920px breakpoints.",
            status: "In Review",
            assignee: { id: 2, name: "Bob Jones", avatar: "https://i.pravatar.cc/150?u=2" },
            priority: "High",
            estimatedHours: 6,
            actualHours: 5,
            createdAt: "2026-01-25",
        ...
        },
        {
            ...
            description: "Build all button variants using CVA (Class Variance Authority) pattern.",
            status: "In Progress",
            assignee: { id: 1, name: "Alice Smith", avatar: "https://i.pravatar.cc/150?u=1" },
            priority: "Medium",
            estimatedHours: 5,
        ...
        },
        {
            ...
            description: "Implement form validation schemas using Zod for all user input forms.",
            status: "Todo",
            assignee: { id: 2, name: "Bob Jones", avatar: "https://i.pravatar.cc/150?u=2" },
            priority: "Medium",
            estimatedHours: 4,
...
const mockAIInsights = {
    102: {
        sprintId: 102,
        autoEstimates: [
            { taskId: "TASK-004", suggestedHours: 6, confidence: 0.92, reason: "Similar to TASK-001" },
            { taskId: "TASK-005", suggestedHours: 4, confidence: 0.87, reason: "Matches bundle optimization pattern" },
        ],
        standupSummary: "Sprint 2 is progressing well at 80% completion. Setup form validation has started, responsive grid is in review. Continue momentum on remaining UI components.",
        riskAssessment: [
            { issue: "Desktop layout not started", severity: "medium", recommendation: "Allocate 2 hours to complete grid layout" },
            { issue: "Bundle optimization low priority", severity: "low", recommendation: "Plan for Sprint 3 if not critical" },
        ],
        recommendations: [
...
export const projectHandlers = [
    ...
    http.get("*/projects/:projectId/sprints/:sprintId/tasks/:taskId/", ({ params }) => {
        const tasks = mockTasks[params.sprintId] || []
    ...
    http.patch("*/projects/:projectId/sprints/:sprintId/tasks/:taskId/", async ({ params, request }) => {
        const tasks = mockTasks[params.sprintId] || []
    ...
    http.post("*/projects/:projectId/sprints/:sprintId/tasks/:taskId/comments/", async ({ params, request }) => {
        const tasks = mockTasks[params.sprintId] || []
        const task = tasks.find((t) => t.id === params.taskId)
        if (!task) {
            return new HttpResponse(null, { status: 404 })
    ...
    http.get("*/projects/:projectId/sprints/:sprintId/ai-insights/", ({ params }) => {
    ...
    http.patch("*/projects/:projectId/workflows/:workflowId/", async ({ params, request }) => {
    ...
    // Analytics endpoints
    http.get("*/projects/:projectId/sprints/:sprintId/analytics/", ({ params }) => {
